...
# Set variables here:
maxStringLength=63
apiURL="https://jss.appannie.org:10023/JSSResource/computers/macaddress/"
apiUser="api-read-sites"#This should be replaced with $4 in Jamf
apiPass="rzKnVB3bnV@UfMCFFj7iu8X*@PYU"#This should be replaced with $5 in Jamf
...
# DEBUG BLOCK
lastName="mcqueen's big long name with all kinds of garbage in here234523452345! It %@(*@%) apparently needs to be even longer??????"
